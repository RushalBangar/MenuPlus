...
MOCK_MENU = [
    {
        ...
        "description": "Diver scallops, sunchoke purée, pickled shimeji mushrooms, herb emulsion.",
        "price": 28.00,
        "category": "Appetizers",
        "is_available": True,
    ...
    },
    {
        ...
        "description": "Lightly battered squid rings, roasted garlic aioli, lemon zest.",
        "price": 14.50,
        "category": "Appetizers",
        "is_available": True,
    ...
    },
    {
        "id": 3,
        "name": "Classic Burger",
        "description": "Juicy beef patty, cheddar, lettuce, tomato, special sauce.",
        "price": 12.99,
        "category": "Mains",
        "is_available": True,
    ...
    },
    {
        ...
        "description": "Charcoal grilled Wagyu steak, black garlic tare, smoked sea salt.",
        "price": 85.00,
        "category": "Mains",
        "is_available": True,
        "image_url": "https://images.unsplash.com/photo-1558030006-450675393462?w=500&q=80",
    },
    {
        "id": 5,
        "name": "Miso Glazed Cod",
        "description": "Sustainably sourced black cod, baby bok choy, dashi broth, chili oil.",
        "price": 42.00,
        "category": "Mains",
        "is_available": True,
        "image_url": "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=500&q=80",
    },
    {
        "id": 6,
        "name": "Vegan Wrap",
        "description": "Grilled Mediterranean vegetables, organic hummus, baby spinach.",
        "price": 10.50,
        "category": "Mains",
        "is_available": True,
    ...
    },
    {
        ...
        "description": "Wood-fired sourdough crust, San Marzano tomato sauce, fresh mozzarella.",
        "price": 15.99,
        "category": "Mains",
        "is_available": True,
    ...
    {
        "id": 8,
        "name": "Maitake Mushroom Forest",
        "description": "Roasted hen-of-the-woods, pea purée, truffle snow.",
        "price": 34.00,
        "category": "Mains",
        "is_available": True,
    ...
    },
    {
        "id": 9,
        "name": "Truffle Fries",
        "description": "Hand-cut crispy fries with black truffle oil and parmesan.",
        "price": 6.99,
        "category": "Sides",
        "is_available": True,
    ...
    {
        "id": 10,
        "name": "The Nebula Sour",
        "description": "Empress gin, clarified lemon, yuzu foam, interactive smoke bubble presentation.",
        "price": 22.00,
        "category": "Drinks",
        "is_available": True,
    ...
    },
    {
        ...
        "category": "Drinks",
        "is_available": True,
        "image_url": "https://images.unsplash.com/photo-1515823662972-da6a2e4d3002?w=500&q=80",
    },
    {
        "id": 12,
        "name": "Tiramisu Delight",
        "description": "Traditional Italian coffee-flavored layer cake.",
        "price": 7.50,
        "category": "Desserts",
        "is_available": True,
...
def get_ai_recommendations(req: AIRecommendationRequest):
    ...
    # Smart pairing logic
    if (
        3 in selected_ids or 7 in selected_ids or 4 in selected_ids
    ):  # Burger/Pizza/Wagyu -> Truffle Fries & Nebula Sour
        ...
        1 in selected_ids or 5 in selected_ids
    ):  # Scallops or Cod -> Recommend Matcha Latte & Tiramisu
        ...
        recommendations.append(MOCK_MENU[8])  # Truffle Fries
        reasoning = (
            "Chef's top recommendation for today based on high customer ratings."
        )
        offer = "Special Combo Saver available!"

    return AIRecommendationResponse(
        recommended_items=recommendations, reasoning=reasoning, discount_offer=offer
    )
...
def get_inventory_forecast():
    ...
    return [
        ...
        DemandForecast(
            ingredient_name="A5 Wagyu / Beef Patties",
            current_stock=14.0,
            unit="Kg",
